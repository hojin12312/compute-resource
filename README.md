...
![Kimi K3 발표와 증시 파급력 시각화](./assets/stock_market_shockwave.jpg)
...
![에이전트 시대 토큰 소비 폭증 트렌드](./assets/token_consumption_growth.jpg)
...
![GPU VRAM 메모리 구성요소 및 할당 구조](./assets/vram_memory_breakdown.jpg)
...
![KV 캐시 비유: 과거를 기억하기 위해 점점 넓어지는 작업 책상](./assets/kv_cache_desk_metaphor.jpg)
...
![프리필 연산: Compute-Bound 병렬 처리](./assets/prefill_compute_bound.jpg)
...
![디코딩 연산: Memory-Bandwidth-Bound 순차 처리](./assets/decoding_bandwidth_bound.jpg)
...
![KV 캐시 히트와 토큰 API 비용 구조 시각화](./assets/cache_hit_pricing.jpg)
...
![Mixture of Experts(MoE) 노드 활성화 다이어그램](./assets/moe-active-nodes.jpg)
...
![Qwen3 Gated DeltaNet 3:1 하이브리드 레이어 스택](./assets/gated_deltanet_pattern.jpg)
...
![Kimi K3 3대 핵심 구조 (KDA, Attention Residuals, Stable LatentMoE)](./assets/kimi_k3_components.jpg)

![3대 LLM 어텐션 계보 비교 다이어그램](./assets/attention_lineage_comparison.jpg)
...
![Hadamard 회전을 통한 KV 캐시 이상치 분산 및 양자화](./assets/kv_cache_hadamard_rotation.jpg)
...
![글로벌 AI 컴퓨트 소버린 지형도](./assets/ai_compute_sovereignty.jpg)
